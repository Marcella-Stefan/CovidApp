...
public class Email {
	...
	public void sendEmail() throws MessagingException {
		...
		transport.close();
		System.out.println("Success, the emails have been sent!");
	}

	public MimeMessage draftEmail() throws AddressException, MessagingException {
				String emailSubject = "Warning!";
				String emailBody = "Restrict your movements!";
				mimeMessage = new MimeMessage(newSession);
				
				for (int i = 0 ; i < emails.size() ; i++) {
					mimeMessage.addRecipient(Message.RecipientType.TO, new InternetAddress(emails.get(i)));
				}
